...
// Returns the pointillisme extruder sequence for a mixed row (used only for
// the early-exit check in build_local_z_plan; the actual pointillisme
// assignment happens in GCode path domain).
